...
const Donut_visual4 = ({ key, data, genderFilter, ageFilter }) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      const filteredData = fData.filter((d) => d["Panic attacks"] === '1');
  ...
  return (
    <div id="Donut_visual4" style={{ width: '99%', height: '99%' }}>
      {/* Tooltip */}
