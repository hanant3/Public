...
const Donut_visual2 = ({ key, data, genderFilter, ageFilter }) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      const filteredData = fData.filter((d) => d.Depression === '1');
  ...
  return (
    <div id="Donut_visual2" style={{ width: '99%', height: '99%' }}>
      {/* Tooltip */}
