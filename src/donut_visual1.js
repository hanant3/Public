...
const Donut_visual1 = ({ key, data, genderFilter, ageFilter }) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      const filteredData = fData.filter((d) => d.Anxiety === '1');
  ...
  return (
    <div id="Donut_visual1" style={{ width: '99%', height: '99%' }}>
      {/* Tooltip */}
