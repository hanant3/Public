...
const Donut_visual5 = ({ key, data, genderFilter, ageFilter }) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      const filteredData = fData.filter((d) => d["Mood swings"] === '1');
  ...
  return (
    <div id="Donut_visual5" style={{ width: '99%', height: '99%' }}>
      {/* Tooltip */}
