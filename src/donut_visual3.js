...
const Donut_visual3 = ({ key, data, genderFilter, ageFilter }) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      const filteredData = fData.filter((d) => d["Obsessive thinking"] === '1');
      ...
      g.append('text')
        ...
        .text('Obsessive thinking');
    }
  }, [key, data, genderFilter, ageFilter]);

  return (
    <div id="Donut_visual3" style={{ width: '99%', height: '99%' }}>
      {/* Tooltip */}
